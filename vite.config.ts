...
const getGitCommitId = (): string => {
  try {
    execSync('git rev-parse --verify HEAD', { encoding: 'utf8', stdio: 'ignore' })
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        short_name: 'LufeiBoard',
        description: 'Lufei-ClashBoard - a dashboard for Clash API, Mihomo and sing-box',
        theme_color: '#000000',
        icons: [
          {
            src: './pwa-192x192.png',
