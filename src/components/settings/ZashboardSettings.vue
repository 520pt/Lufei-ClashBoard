<template>
  ...
  >
    ...
    <div
        ...
        class="mt-4 grid max-w-3xl grid-cols-2 gap-2 gap-y-3 md:grid-cols-5"
    >
      <button
      ...
      <button
        v-if="isVisibleImportSettings"
        class="btn btn-secondary btn-sm"
        @click="handleImportLufeiSelfUseSettings"
      >
        路飞自用
      </button>
    </div>
...
import {
  importLufeiSelfUseSettings,
  lufeiSelfUseSettingsEnabled,
...
const handleImportLufeiSelfUseSettings = async () => {
  lufeiSelfUseSettingsEnabled.value = true
  await importLufeiSelfUseSettings(true)
}
